...
<Cards>
  <Card title="Callout" href="https://nextra.site" />
  <Card title="Tabs" href="https://nextra.site" />
  <Card title="Steps" href="https://nextra.site" />
</Cards>
...
<Callout type="warning" emoji="⚠️"> This install is **not** suitable for [production use](https://ghost.org/docs/install/ubuntu/) or [contributing](https://ghost.org/docs/install/source/) to core.</Callout>
